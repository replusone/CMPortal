...
if(isset($_POST['profile']) === true){
	if(empty($_POST['profile']) === true){
		$errors[1] = '<font color="red"> please choose a file</font>';
	}else{
		$file_path = $_POST['profile'];
		change_profile_image($session_user_id, $file_path);
...
<div class="form1">
    <a href="javascript:void(0)" onclick="toggle_sidenav_visibility('popupBoxTwoPosition');" id="closewindow"><i class="material-icons">close</i></a>
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="row">
		    <div class="input-field col s12">
				<input type="submit" class="btn-large" name="upload" value="UPLOAD"/><br>
			</div>
		</div>
		<div class="row">
		    <div class="input-field col s12">
